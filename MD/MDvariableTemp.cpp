...
/**
 * __Objetivo__ : Explorar los cambios de temperatura en una cadena determinada
 * Subir y luego bajar la temperatura, he observado que rangos de temperatura
 * entre 0.04 a 0.07 la cadena no se llega a romper asi que seria bueno oscilar
 * entre estos valores.
 * */
